...
// dividers by framework
const ProjectTabs = props => (
  <div className="tabs is-centered is-large is-boxed is-fullwidth is-mobile">
    <ul onClick={e => props.onSelect(e.target.className)} onKeyUp={props.onKeyPress}>
      <li className={props.isSelected('all')}><a className="all">All</a></li>
      <li className={props.isSelected('nodejs')}><a className="nodejs">Node.js</a></li>
      <li className={props.isSelected('react')}><a className="react">React</a></li>
      <li className={props.isSelected('angular')}><a className="angular">Angular</a></li>
    </ul>
  </div>
);
